...
# 第二部分：源代码优化 {#sec:SourceCodeTuning .unnumbered}

\markboth{重点}{第二部分：源代码优化}
...
\personal{实际上，我们可以说所有的优化在某种程度上都是数据驱动的。即使是我们将在下一节看到的转换，也是基于我们从程序执行中获得的一些反馈：函数调用次数，分支是否被采取，性能计数器等。}
